...
angular.module('openfb', [])
    ...
    .factory('OpenFB', function ($rootScope, $q, $window, $http) {
        ...
        // By default we store auth_token in sessionStorage. This can be overriden in init()
        ...
        function oauthCallback(url) {
            ...
            if (url.indexOf("access_token=") > 0) {
                ...
                tokenStore['auth_token'] = obj['access_token'];
        ...
        function api(obj) {
            ...
            params['access_token'] = tokenStore['auth_token'];
